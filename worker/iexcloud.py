...
class Fundamentals:
    # custom_search_url = 'https://cloud.iexapis.com/stable/stock/ADBE/quote/latestPrice?token=pk_8dacda7ce2f940efbc2837e15147551b'
    def __init__(self, ticker):
        config = load_configuration('iexfinance.cfg')
        self._stock = Stock(ticker, token=config['token'])
